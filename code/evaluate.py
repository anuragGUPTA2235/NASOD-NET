...
PASCAL_VOC_DIR_PATH = "/all/cse/sunil/mscoco"

# Trained Model Path
TRAINED_MODEL_WEIGHTS = "nextgen3.pth"
...
def plot_class_ap(average_precisions: List[float]) -> None:
    ...
    save_path = '/home/uday/anurag/headofdetectors/goddetector/code/map.png'
